        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <h2 className="text-5xl sm:text-7xl md:text-8xl font-extrabold uppercase tracking-tight leading-[0.92] font-display text-white">
              FITNESS.<br />
              <span className="text-white/60">WITHOUT THE</span><br />
              <span className="text-[#FFC515]">GUESSWORK.</span>
            </h2>

            {/* Supporting Step-by-Step Copy */}
            <div className="space-y-3 font-mono-num text-sm sm:text-base text-white/80 border-l border-[#FFC515]/40 pl-6 py-2">
              <p className="flex items-center gap-3">
                <span className="text-[#FFC515] font-bold">01.</span> Calculate your calories.
              </p>
              <p className="flex items-center gap-3">
                <span className="text-[#FFC515] font-bold">02.</span> Know what to eat.
              </p>
              <p className="flex items-center gap-3">
                <span className="text-[#FFC515] font-bold">03.</span> Know how to train.
              </p>
              <p className="flex items-center gap-3">
                <span className="text-[#FFC515] font-bold">04.</span> Track your progress.
              </p>
              <p className="flex items-center gap-3">
                <span className="text-[#FFC515] font-bold">05.</span> Stay consistent.
              </p>
            </div>

            {/* Short Brand Statement */}
            <p className="text-white/60 text-sm sm:text-base font-mono-num leading-relaxed max-w-xl border-t border-white/10 pt-6">
            ...
            <div className="pt-2">
              <button
                ...
                className="px-8 py-4 bg-[#101014] hover:bg-white/10 border border-white/20 hover:border-white/50 text-white font-mono-num font-bold text-xs uppercase tracking-wider flex items-center gap-3 transition-colors"
              >
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative border border-white/15 bg-[#101014] overflow-hidden">
              <img
              ...
              <div className="absolute bottom-6 left-6 right-6 p-4 bg-black/85 backdrop-blur-sm border border-white/10 font-mono-num text-xs">
                <span className="text-[10px] text-white/40 uppercase tracking-widest block">DISCIPLINE PRINCIPLE</span>
                <span className="text-white font-bold block mt-0.5">ELIMINATE AMBIGUITY. EXECUTE DAILY.</span>
              </div>
            </div>

            {/* Decorative subtle ambient accent */}
            <div className="absolute -bottom-10 -right-10 w-48 h-48 bg-[#FFC515]/10 rounded-full blur-3xl pointer-events-none" />
          </div>
